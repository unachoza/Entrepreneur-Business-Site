        ...
        <Grid item container direction="column" alignItems={matchesMD ? 'center' : undefined} lg>
          ...
          <Grid item>
            ...
            <Typography
              ...
              paragraph
            >
              We give you an interactive demonstration of the mockups, thoroughly explaining the thought process that
              went into each screen and every anticipated feature.
            </Typography>
            <Typography
              variant="body1"
              align={matchesMD ? 'center' : undefined}
        ...
        <Grid item container direction="column" alignItems={matchesMD ? 'center' : undefined} lg>
          ...
          <Grid item>
            <Typography
              ...
              paragraph
            >
              A second round of review is essential to our goal of creating exactly what you want, exactly how you want
              it.
            </Typography>
            <Typography
              variant="body1"
              ...
              paragraph
            >
              This time we’ll be going over the finalized designs in another fully interactive demonstration. Again this
              gives you an opportunity to tweak things and make sure we get everything right the first time.
            </Typography>
          </Grid>
        </Grid>
        <Grid item lg style={{ alignSelf: 'center' }}>
